...
if __name__ == '__main__':
    graph = DiGraph()
    graph.add_node(1, (4, 7, 0))
    graph.add_node(2, (2, 0, 0))
    graph.add_node(3, (4, 4, 0))
    graph.add_node(4, (7, 10, 0))
    ...
    # xr2 = Range(0, 1)
    # yr2 = Range(0, 1)
    # dim2 = Range2D(xr2, yr2)
    # r2r = Range2Range(dim2, dim)
    # x, y = r2r.world_to_frame(0.1, 0.5)
    # print(x, y)
